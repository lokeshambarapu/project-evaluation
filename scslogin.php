		...
		if(isset($_REQUEST['pid']))
		{
			if(isset($_REQUEST["pass"]))
			{
				...
				while($row=mysql_fetch_array($result))
				{
					...
					elseif(($row['uid']==$pinno) && ($row['passwd']==$password) && ($row['type']=="hod"))
					{
						$_SESSION['uname']=$row['uname'];
						$flag=1;
...
?>
	<div id="head">
		<font face="verdana" size="px"><h1>Student Counselling System <font face="verdana" color="green"><sub> - Department of CSE</sub></font></h1>
	</div>        
	<div id="center1">
		<ul class="ppt">
	...
	<div id="textarea" >
		<center><h4>Sign in</h4>
			...
			<form name="myform" action="scslogin.php" method="post" onsubmit="return validate()">
				...
				<tr>
				<td> User Name :</td>
				<td><input id="pid" type="text" name="pid" maxlength="16" placeholder="  User Name" onchange="return validatename()"> </td>
				<td><span id="nameerror" class="error">Username is required</span></td>
				</tr>
				<tr>
				<td> Password &nbsp; : </td>
				<td width="200"><input id="passwd" type="password" name="pass" maxlength="16" placeholder="  Password" onchange="return validatepass()"</td>
				<td><span id="passerror" class="error">Password is required</span></td>
				</tr></table>
